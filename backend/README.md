...
abi/screenshot-to-code fork), `NOVA_ACT_API_KEY`, `USERSYNC_ENGINE` (open|nova|auto), `USERSYNC_PUBLIC_BASE_URL`, `FREE_CREDITS`. LLM access is strictly BYOK — no server-side model keys.
